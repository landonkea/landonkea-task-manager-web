...
# It creates JSON keys for :id, :name, :done, :due_on, :priority, :notes, :created_at, and :updated_at.
...
json.extract! task, :id, :name, :done, :due_on, :priority, :notes, :created_at, :updated_at
